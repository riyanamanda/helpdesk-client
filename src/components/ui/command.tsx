    ...
    return (
        <div data-slot="command-input-wrapper" className="flex items-center border-b px-3">
            ...
            <CommandPrimitive.Input
                ...
                className={cn(
                    "flex h-9 w-full rounded-lg bg-transparent py-3 pl-2 text-sm outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
                    className
                )}
                {...props}
            />
